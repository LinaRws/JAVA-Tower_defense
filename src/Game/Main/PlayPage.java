...
import Game.Main.Models.Tiles.Fond;
import Game.Main.Models.Tiles.Arbre;
import Game.Main.Models.Tiles.Chateau;
import Game.Main.Models.Tiles.Chemin;
  ...
  private Tile createTileFromId(int id, int x, int y) {
    switch (id) {
      ...
      case 1:
        return new Fond(x, y);
      case 2:
        return new Chemin(x, y);
      case 3:
        return new Chateau(x, y);
      default:
        return null;
    }
  }
